...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-987f46fe><div class="max-w-full px-4" data-v-987f46fe><div class="flex items-center justify-between navbar-height" data-v-987f46fe>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", logoSrc)} alt="FunInATL" class="block" style="${ssrRenderStyle({ "max-height": "90px" })}" data-v-987f46fe${_scopeId}><span class="navbar-brand-name font-bold tracking-tight absolute" style="${ssrRenderStyle({ "left": "30px", "font-size": "2rem" })}" data-v-987f46fe${_scopeId}>FunInATL</span>`);
          } else {
            return [
              createVNode("img", {
                src: logoSrc,
      ...
      _push(`<div class="hidden md:flex items-center gap-1" data-v-987f46fe><!--[-->`);
      ...
      if (unref(auth).isLoggedIn) {
        ...
        _push(`<button class="ml-2 px-4 py-2 text-sm font-medium bg-danger hover:opacity-90 text-white rounded transition-opacity" data-v-987f46fe> Logout </button><!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><button class="md:hidden flex flex-col justify-center items-center w-10 h-10 gap-1.5 cursor-pointer" aria-label="Toggle menu" data-v-987f46fe><!--[-->`);
      ssrRenderList(3, (i) => {
        _push(`<span class="block w-6 h-0.5 bg-white transition-all" data-v-987f46fe></span>`);
      });
      _push(`<!--]--></button></div>`);
      if (unref(menuOpen)) {
        _push(`<div class="md:hidden pb-4 flex flex-col border-t border-white/10 mt-1" data-v-987f46fe><!--[-->`);
        ssrRenderList(navLinks, (link) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            key: link.to,
            to: link.to,
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-987f46fe"]]), { __name: "AppHeader" });
...
//# sourceMappingURL=default-eC0DDscM.mjs.map
