...
const styles = {
  ...
  "components/AppHeader.vue": () => import('./AppHeader-styles.CqLlT7EY.mjs').then(interopDefault),
  "components/AppHeader.vue?vue&type=style&index=0&scoped=9fef4b1a&lang.css": () => import('./AppHeader-styles.CqLlT7EY.mjs').then(interopDefault)
};
