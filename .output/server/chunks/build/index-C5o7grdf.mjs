...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="px-4 py-5"><div class="flex flex-wrap gap-3 items-start"><div class="relative flex-1 min-w-32"><input${ssrRenderAttr("value", unref(query))} type="search" placeholder="Search for an event" class="w-full px-4 py-3 text-gray-900 text-base rounded border-0 focus:outline-none focus:ring-2 focus:ring-white/50 bg-white/75">`);
      ...
      if (__props.categories && __props.categories.length) {
        _push(`<select class="px-3 py-3 text-gray-900 text-base rounded border-0 focus:outline-none focus:ring-2 focus:ring-white/50 min-w-36 bg-white/75" aria-label="Filter by category"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filters).category) ? ssrLooseContain(unref(filters).category, "") : ssrLooseEqual(unref(filters).category, "")) ? " selected" : ""}>Category</option><!--[-->`);
      ...
      if (__props.locations && __props.locations.length) {
        _push(`<select class="px-3 py-3 text-gray-900 text-base rounded border-0 focus:outline-none focus:ring-2 focus:ring-white/50 min-w-36 bg-white/75" aria-label="Filter by location"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filters).location) ? ssrLooseContain(unref(filters).location, "") : ssrLooseEqual(unref(filters).location, "")) ? " selected" : ""}>Location</option><!--[-->`);
