  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`<div class="flex flex-wrap items-end gap-4 mt-4">`);
        ...
        if (unref(event).website) {
          _push(`<a${ssrRenderAttr("href", unref(event).website)} target="_blank" rel="noopener" class="inline-flex items-center gap-2 bg-indigo hover:opacity-90 text-white text-sm font-medium px-4 py-2 rounded transition-opacity no-underline"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path></svg> Venue Website </a>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=_slug_-k7ObVnR7.mjs.map
